...
contract UnderwritingSettlementEscrowTest is Test {
    ...
    UnderwritingSettlementEscrow internal escrow;

    function setUp() public {
        usdc = new MockERC20("Mock USDC", "mUSDC");
        collateralManager = new MockCollateralManager(usdc);
        escrow = new UnderwritingSettlementEscrow(address(usdc), collateralManager, controller);
    ...
    function testReleasePrincipalCallsCollateralManagerAndTransfersToMerchantWallet() public {
        ...
        escrow.releasePrincipalToMerchant(permit, bytes("permit-sig"));
