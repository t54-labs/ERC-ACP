...
| [MCU Hook System](./mcu/README.md) | **mcu/** | Experimental Merchant Custody Underwriting profile built on ACP hooks with single-stage and two-stage flows, hook-managed linkage, explicit coordination, per-job adapters, and underwriter-signed evaluation. |
